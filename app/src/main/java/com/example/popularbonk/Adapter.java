...
public class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
    ...
    public void setListData(List<ArticlesItem> articles) {
        this.articles.clear();
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.aitem, parent, false);
...
//        holder.time.setText("\u2022" + Utils.DateToTimeFormat(model.getPublishedAt()));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public MyViewHolder(@NonNull View itemView, OnItemClickListener onItemClickListener) {
            ...
            source = itemView.findViewById(R.id.sors);
//            time = itemView.findViewById(R.id.taim);
            imageView = itemView.findViewById(R.id.img);
            progressBar = itemView.findViewById(R.id.progeras_lod__foto);
